# https://bbs.archlinux.org/viewtopic.php?id=304385
# override bluez from 5.80 to 5.82 in order to fix issues with bluetooth on my x280
# TODO: remove when 5.82 is in stable nix.
{
  lib,
  stdenv,
  alsa-lib,
